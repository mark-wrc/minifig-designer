  ...
  return (
    <>
      <header className="mb-10 text-black text-center pt-12 md:hidden">
        <StyledText
          className="text-[1.5em] font-black leading-none mx-0.5 mb-3 text-gray-900"
